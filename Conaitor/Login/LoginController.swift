...
class LoginController: UIViewController, CLLocationManagerDelegate{
  ...
  override func viewDidLoad() {
    ...
    self.autenticarBtn.customBackgroundTitleColor(titleColor: Customization.primaryColor, backgroundColor: Customization.secundaryColor)
    self.RecuperarClaveBtn.customBackgroundTitleColor(titleColor: Customization.primaryColor, backgroundColor: Customization.secundaryColor)
    self.crearNewPasswordText.customBackgroundTitleColor(titleColor: Customization.primaryColor, backgroundColor: Customization.secundaryColor)
    self.crearCuentaBtn.customBackgroundTitleColor(titleColor: Customization.primaryColor, backgroundColor: Customization.secundaryColor)
    self.closeRecoverViewBtn.customImageColor(color: Customization.secundaryColor, backgroundColor: Customization.buttonActionColor)
    self.closeRegisterViewBtn.customImageColor(color: Customization.secundaryColor, backgroundColor: Customization.buttonActionColor)
    self.closeNewPassViewBtn.customImageColor(color: Customization.secundaryColor, backgroundColor: Customization.buttonActionColor)
    self.showHideClaveBtn.customImageColor(color: Customization.secundaryColor, backgroundColor: Customization.buttonActionColor)
    self.showHideRegistroBtn.customImageColor(color: Customization.secundaryColor, backgroundColor: Customization.buttonActionColor)
    self.showHideConfirmClave.customImageColor(color: Customization.secundaryColor, backgroundColor: Customization.buttonActionColor)
    ...
    self.usuario.customTextField(textColor: Customization.secundaryColor, backgroundColor: Customization.primaryColor)
    self.clave.customTextField(textColor: Customization.secundaryColor, backgroundColor: Customization.primaryColor)
    self.telefonoText.customTextField(textColor: Customization.secundaryColor, backgroundColor: Customization.primaryColor)
    self.nombreApText.customTextField(textColor: Customization.secundaryColor, backgroundColor: Customization.primaryColor)
    self.claveText.customTextField(textColor: Customization.secundaryColor, backgroundColor: Customization.primaryColor)
    self.confirmarClavText.customTextField(textColor: Customization.secundaryColor, backgroundColor: Customization.primaryColor)
    self.correoText.customTextField(textColor: Customization.secundaryColor, backgroundColor: Customization.primaryColor)
    self.movilClaveRecover.customTextField(textColor: Customization.secundaryColor, backgroundColor: Customization.primaryColor)
    self.newPasswordText.customTextField(textColor: Customization.secundaryColor, backgroundColor: Customization.primaryColor)
